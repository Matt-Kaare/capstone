          ...
          <div class="col-lg-6">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Login to Profile</h1>
              </div>

              <form class="user" method="post" action="backend.php">
              ...
              <div class="text-center">
                <a class="small" href="registration_form.php">Create an Account!</a>
              </div>
